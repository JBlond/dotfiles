...
if command -q fd
    abbr greedy 'fd --hidden --no-ignore --max-depth 1 --print0 '^' | xargs -0 -n1 -P4 du -sh | sort -rh'
else
    abbr greedy 'find . -mindepth 1 -maxdepth 1 -print0 | xargs -0 -n1 -P4 du -sh | sort -rh'
end
