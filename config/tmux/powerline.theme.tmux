...
# active window
set -g window-status-current-format "#[fg=black,bg=colour214,nobold,noitalics,nounderscore]#[fg=colour238,bg=colour214] #I #[fg=brightwhite,bg=colour238] #(icons #{pane_current_command}) #[fg=colour238,bg=black,nobold,noitalics,nounderscore]"
